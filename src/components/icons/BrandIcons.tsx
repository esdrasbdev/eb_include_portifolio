...
export function LinkedinIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} {...props}>
      ...
      <path d="M11.5 17v-4.2c0-1.6 1-2.3 2.2-2.3 1.3 0 2.3.8 2.3 2.3V17" />
...
export function BasketballIcon({ size = 24, ...props }: SVGProps<SVGSVGElement> & { size?: number }) {
  return (
    <svg viewBox="0 0 24 24" width={size} height={size} fill="none" stroke="currentColor" strokeWidth={1.5} {...props}>
      <circle cx="12" cy="12" r="9" />
      <path d="M3 12h18" />
      <path d="M12 3v18" />
      <path d="M5.64 5.64c2 2 3.1 4 3.1 6.36s-1.1 4.36-3.1 6.36" />
      <path d="M18.36 5.64c-2 2-3.1 4-3.1 6.36s1.1 4.36 3.1 6.36" />
    </svg>
  )
}
